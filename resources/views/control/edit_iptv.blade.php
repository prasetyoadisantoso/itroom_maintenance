...
@section('content')
    <div class="container mt-5 mb-5">
        <h3 class="text-center">Edit data IPTV</h3>
    </div>
    @foreach($rooms as $read)
    <div class="container card">
        <div class="card-body my-2 mx-2">
        <form action="{{url('/createiptv/edit/' . $read->id)}}" method="post">
            @csrf
            {{method_field('PATCH')}}
            ...
            <div class="form-group">
                ...
                <select name="remote" class="form-control" id="remote">
                    <option value="{{ $read->remote }}">{{ $read->remote }}</option>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="noteremote" name="noteremote" placeholder="Masukan Note..." value="{{$read->noteremote}}">
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <select name="stb" class="form-control" id="stb">
                    <option value="{{ $read->stb }}">{{ $read->stb }}</option>
                    <option value="GOOD">GOOD</option>
                    <option value="NO">NO</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="notestb" name="notestb" placeholder="Masukan Note..." value="{{$read->notestb}}">
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <select name="ir" class="form-control" id="ir">
                    <option value="{{ $read->ir }}">{{ $read->ir }}</option>
                    <option value="GOOD">GOOD</option>
                    <option value="NO">NO</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="noteir" id="noteir" placeholder="Masukan Note..." value="{{$read->noteir}}">
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <select name="powersupply" class="form-control" id="powersupply">
                    <option value="{{ $read->powersupply }}">{{ $read->powersupply }}</option>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="macaddress" name="macaddress" placeholder="Masukan Mac Address..." value="{{$read->macaddress}}">
            </div>
            <br>
