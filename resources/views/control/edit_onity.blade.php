...
@section('content')
    <div class="container mt-5 mb-5">
        <h3 class="text-center">Edit data ONITY</h3>
    </div>
    @foreach($rooms as $read)
    <div class="container card">
        <div class="card-body my-2 mx-2">
        <form action="{{url('/createonity/edit/' . $read->id)}}" method="post">
            @csrf
            {{method_field('PATCH')}}
            ...
            <div class="form-group">
                ...
                <input width="276" class="form-control" id="date" name="date" aria-describedby="date" placeholder="date" value="{{$read->date}}">
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <select name="rooms_id" class="form-control" id="rooms_id">
                    <option value="{{ $read->rooms_id }}">DEFAULT</option>
            ...
            <div class="form-group">
                ...
                <select name="cable" class="form-control" id="cable">
                    <option value="{{ $read->cable }}">{{ $read->cable }}</option>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="notecable" id="notecable" placeholder="Masukan Note..." value="{{$read->notecable}}">
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <select name="dnd" class="form-control" id="dnd">
                    <option value="{{ $read->dnd }}">{{ $read->dnd }}</option>
                    <option value="GOOD">GOOD</option>
                    <option value="NO">NO</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="notednd" name="notednd" placeholder="Masukan Note..." value="{{$read->notednd}}">
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <select name="bel" class="form-control" id="bel">
                    <option value="{{ $read->bel }}">{{ $read->bel }}</option>
                    <option value="GOOD">GOOD</option>
                    <option value="NO">NO</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="notebel" name="notebel" placeholder="Masukan Note..." value="{{$read->notebel}}">
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <select name="keytag" class="form-control" id="keytag">
                    <option value="{{ $read->keytag }}">{{ $read->keytag }}</option>
                    <option value="GOOD">GOOD</option>
                    <option value="NO">NO</option>
                </select>
            </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="notekeytag" name="notekeytag" placeholder="Masukan Note..." value="{{$read->notekeytag}}">
                </div>
                <br>
            ...
            <div class="form-group">
                ...
                <select name="reader" class="form-control" id="reader">
                    <option value="{{ $read->reader }}">{{ $read->reader }}</option>
                    <option value="GOOD">GOOD</option>
                    <option value="NO">NO</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="notereader" name="notereader" placeholder="Masukan Note..." value="{{$read->notereader}}">
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <select name="safetybox" class="form-control" id="safetybox">
                    <option value="{{ $read->safetybox }}">{{ $read->safetybox }}</option>
                    <option value="GOOD">GOOD</option>
                    <option value="NO">NO</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="notesafetybox" name="notesafetybox" placeholder="Masukan Note..." value="{{$read->notesafetybox}}">
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="remark" name="remark" placeholder="Masukan Remark..." value="{{$read->remark}}">
            </div>



            <br>
            <button type="submit" class="btn btn-primary" value="Tambah">UPDATE</button>
