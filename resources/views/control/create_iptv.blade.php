...
@section('content')
    <div class="container mt-5 mb-5">
        <h3 class="text-center">Add data IPTV</h3>
    </div>
    <div class="container card">
        <div class="card-body my-2 mx-2">
        <form action="{{url('/createiptv/store')}}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="noteremote" name="noteremote" placeholder="Masukan Note...">
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="notestb" name="notestb" placeholder="Masukan Note...">
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="noteir" id="noteir" placeholder="Masukan Note...">
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="macaddress" name="macaddress" placeholder="Masukan Mac Address...">
            </div>
            <br>
